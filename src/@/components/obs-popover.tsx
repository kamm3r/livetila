  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      >
        ...
        <motion.span layoutId="title" className="sr-only sm:not-sr-only">
          OBS Overlay
        </motion.span>
      </PopoverTrigger>
      <AnimatePresence>
        {open && (
          <PopoverContent
            ...
            render={
              <motion.div layoutId="wrapper" style={{ borderRadius: 12 }} />
            }
          >
            <motion.div
            ...
            >
              <PopoverHeader>
                <PopoverTitle render={<motion.h2 layoutId="title" />}>
                  OBS Overlay
                </PopoverTitle>
                <PopoverDescription>
              ...
              <div className="flex flex-col gap-4">
                <div className="space-y-2">
                  ...
                  <div className="text-xs text-muted-foreground">
                    Vaihda <code>round</code> ja <code>heat</code> arvoja
                    tarpeen mukaan.
                  </div>
                </div>
                <Embed slug={slug} />
