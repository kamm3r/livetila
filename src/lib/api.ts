import type { Competition, CompetitionList, CompetitionProperties, Events } from "~/types/comp";
...
export const api = {
	...
	getCompetitionDetails(competitionDetailsId: string): Promise<CompetitionProperties> {
