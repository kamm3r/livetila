<script lang="ts">
  ...
  const showDropdown = $derived(
    isFocused && query.length > 0 && (isLoading || hasResults),
  );
          ...
          <div class="p-2">
            <div class="max-h-80 overflow-y-auto">
              ...
              {:else if step === "competitions"}
                <div
                  class="**:[[cmdk-group-heading]]:px-2 **:[[cmdk-group-heading]]:pb-2 **:[[cmdk-group-heading]]:font-semibold **:[[cmdk-group-heading]]:text-muted-foreground/70 **:[[cmdk-group-heading]]:text-xs **:[[cmdk-group-heading]]:uppercase **:[[cmdk-group-heading]]:tracking-wider"
                >
                  <div
                    class="px-2 pb-2 font-semibold text-muted-foreground/70 text-xs uppercase tracking-wider"
                  >
                    Kilpailut
                  </div>
                    ...
                    >
                      ...
                      >
                        <div class="flex items-center gap-2 sm:gap-3">
                          <div
                            class="flex size-8 shrink-0 items-center justify-center rounded-lg bg-primary/10 text-primary group-hover:bg-primary group-hover:text-primary-foreground sm:size-9"
                          >
                        ...
                        <ArrowRight
                          class="size-4 text-muted-foreground opacity-0 transition-all duration-200 group-hover:translate-x-0.5 group-hover:text-primary group-hover:opacity-100"
                        />
                      </div>
                    </button>
                  {/each}
                  ...
                  {#each filteredEvents.slice(0, 15) as evt (evt.Id + evt.Time)}
                    ...
                    >
                      ...
                      >
                        <div class="flex items-center gap-2 sm:gap-3">
                          <div
                            class="relative flex size-8 shrink-0 items-center justify-center rounded-lg bg-accent text-accent-foreground group-hover:bg-primary group-hover:text-primary-foreground sm:size-9"
                          >
                            {#if isNavigating}
